...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/14 11:58:16 by barpent           #+#    #+#             */
/*   Updated: 2024/03/14 11:58:16 by barpent          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void move_a_to_b(t_list **stack_head_a, t_list **stack_head_b)
{
    ...
    cheapest = find_cheapest_cost(*stack_head_a);
    stack_a_len = list_len(*stack_head_a);
    stack_b_len = list_len(*stack_head_b);

    if (cheapest->index <= (stack_a_len / 2) && cheapest->target->index <= (stack_b_len / 2))
        move_rotate_a_and_b(stack_head_a, stack_head_b, cheapest);
    ...
    prepare_stack_a(stack_head_a, cheapest, stack_a_len);
    prepare_stack_b(stack_head_b, cheapest, stack_b_len);
